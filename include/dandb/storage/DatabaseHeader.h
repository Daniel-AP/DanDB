...
namespace dandb::storage {
    ...
    inline constexpr std::uint32_t DATABASE_FORMAT_VERSION = 2;
    inline constexpr std::uint32_t DATABASE_HEADER_SIZE = 128;
    inline constexpr std::size_t DATABASE_HEADER_RESERVED_BYTES_SIZE = 56;
    ...
    inline constexpr std::size_t DATABASE_SYSTEM_TABLES_ROOT_PAGE_ID_OFFSET = DATABASE_PAGE_COUNT_OFFSET+sizeof(std::uint64_t);
