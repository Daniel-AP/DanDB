...
namespace {
    ...
    void benchmark_sql_range_scan_secondary_index(benchmark::State& state) {
...
BENCHMARK(benchmark_sql_range_scan_secondary_index)
    ->Name("SQL/RangeScan/SecondaryIndex")
    ->Arg(1'000)
    ->Arg(10'000)
    ->Arg(100'000)
