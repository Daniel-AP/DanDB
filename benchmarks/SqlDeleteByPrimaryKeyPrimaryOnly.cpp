...
namespace {
    ...
    void benchmark_sql_delete_by_primary_key_primary_only(benchmark::State& state) {
...
BENCHMARK(benchmark_sql_delete_by_primary_key_primary_only)
    ->Name("SQL/DeleteByPrimaryKey/PrimaryOnly")
    ->Arg(1'000)
    ->Arg(10'000)
    ->Arg(100'000)
