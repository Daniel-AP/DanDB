...
namespace {
    ...
    void benchmark_sql_delete_by_primary_key_secondary_index(benchmark::State& state) {
...
BENCHMARK(benchmark_sql_delete_by_primary_key_secondary_index)
    ->Name("SQL/DeleteByPrimaryKey/SecondaryIndex")
    ->Arg(1'000)
    ->Arg(10'000)
    ->Arg(100'000)
