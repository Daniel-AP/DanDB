...
namespace {
    ...
    void benchmark_sql_point_lookup_unique_secondary_index(benchmark::State& state) {
...
BENCHMARK(benchmark_sql_point_lookup_unique_secondary_index)
    ->Name("SQL/PointLookup/UniqueSecondaryIndex")
    ->Arg(1'000)
    ->Arg(10'000)
    ->Arg(100'000)
