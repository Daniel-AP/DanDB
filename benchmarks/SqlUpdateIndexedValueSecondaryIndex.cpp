...
namespace {
    ...
    void benchmark_sql_update_indexed_value_secondary_index(benchmark::State& state) {
...
BENCHMARK(benchmark_sql_update_indexed_value_secondary_index)
    ->Name("SQL/UpdateIndexedValue/SecondaryIndex")
    ->Arg(1'000)
    ->Arg(10'000)
    ->Arg(100'000)
